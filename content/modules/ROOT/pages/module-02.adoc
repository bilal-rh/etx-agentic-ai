...
----
git clone https://github.com/bilal-rh/etx-agentic-ai.git
----
+
...
+
https://github.com/bilal-rh/etx-agentic-ai/blob/main/code/getting-started.ipynb[etx-agentic-ai/code/getting-started.ipynb,window=_blank]
+
